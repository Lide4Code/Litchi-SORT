    ...
    def __init__(
        ...
        # TensorRT
            ...
            try:
                ...
                LOGGER.error(
                    "ERROR: TensorRT engine failed to deserialize. "
                    f"This is usually caused by a TensorRT/plugin/CUDA mismatch, or by exporting the engine on a "
                    f"different platform. Current TensorRT version: {trt.__version__}\n"
                )
                raise e
